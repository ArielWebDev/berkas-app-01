...
const mockMonthlyData = [
  { month: 'Jan', pinjaman: 15, approved: 12, rejected: 3 },
  { month: 'Feb', pinjaman: 22, approved: 18, rejected: 4 },
  { month: 'Mar', pinjaman: 18, approved: 15, rejected: 3 },
  { month: 'Apr', pinjaman: 25, approved: 20, rejected: 5 },
  { month: 'May', pinjaman: 30, approved: 25, rejected: 5 },
  { month: 'Jun', pinjaman: 28, approved: 23, rejected: 5 },
];
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <div className="space-y-8 lg:col-span-2">
                ...
                {/* Status Distribution */}
                <div
                  className={`delay-400 transition-all duration-700 ${
                    isVisible
                      ? 'translate-y-0 opacity-100'
                      : 'translate-y-8 opacity-0'
                  }`}
              ...
              <div className="space-y-8">
                ...
                {/* Recent Applications */}
                <div
                  className={`delay-600 transition-all duration-700 ${
                    isVisible
                      ? 'translate-y-0 opacity-100'
                      : 'translate-y-8 opacity-0'
                  }`}
