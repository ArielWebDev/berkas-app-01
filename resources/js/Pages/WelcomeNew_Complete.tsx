...
const features = [
  {
    ...
    description: 'Kelola semua dokumen penting dengan mudah dan aman.',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: 'Bekerja sama dengan tim secara efisien dan terorganisir.',
  },
  {
    icon: BarChart3,
    title: 'Analitik Real-time',
    description: 'Pantau kinerja dan statistik dengan dashboard interaktif.',
  },
  {
    icon: Globe,
    title: 'Akses Global',
    description:
      'Akses sistem dari mana saja, kapan saja dengan koneksi internet.',
  },
  {
    icon: Zap,
    title: 'Performa Tinggi',
    description:
      'Sistem yang cepat dan responsif untuk produktivitas maksimal.',
  },
];

const stats = [
  { icon: Users, number: '1000+', label: 'Active Users' },
  { icon: FileText, number: '50K+', label: 'Documents Managed' },
  { icon: Award, number: '99.9%', label: 'Uptime Guarantee' },
  { icon: TrendingUp, number: '200%', label: 'Productivity Boost' },
];
...
const workflowSteps = [
  {
    ...
    description: 'Unggah dokumen dengan drag & drop yang mudah',
  },
  {
    icon: Shield,
    title: 'Keamanan Otomatis',
    description: 'Sistem enkripsi otomatis melindungi data Anda',
  },
  {
    icon: Users,
    title: 'Kolaborasi',
    description: 'Share dan berkolaborasi dengan tim secara real-time',
  },
  {
    icon: BarChart3,
    title: 'Monitor & Analisis',
    description: 'Pantau progress dan analisis dengan dashboard',
  },
];
  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        {/* Base Gradient */}
        <div
          className="parallax-bg-ultra animate-gradient-shift-advanced"
        ...
        <div
          className="animate-pulse-glow absolute left-1/4 top-1/4 h-64 w-64 rounded-full bg-blue-400/20 blur-3xl"
          style={{
            transform: `translate(${scrollY * 0.3}px, ${scrollY * 0.2}px)`,
          }}
        />
        <div
          className="animate-pulse-glow absolute bottom-1/4 right-1/4 h-64 w-64 rounded-full bg-purple-400/20 blur-3xl"
          style={{
            transform: `translate(${-scrollY * 0.2}px, ${-scrollY * 0.3}px)`,
            animationDelay: '1.5s',
          }}
            ...
            <div className="flex h-16 items-center justify-between">
              <div className="animate-bounce-in flex items-center space-x-2">
                <div className="relative">
                  <FileText className="animate-rotate-scale h-8 w-8 text-blue-600" />
                  <div className="animate-pulse-glow absolute inset-0" />
                </div>
          ...
          <div className="mx-auto max-w-7xl px-4 pt-20 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                ...
                >
                  Revolusi cara Anda mengelola dokumen dengan teknologi
                  terdepan.
                  <br />
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-xl text-gray-600">
                Dilengkapi dengan teknologi terdepan untuk pengalaman pengguna
                yang luar biasa
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-3xl text-xl text-gray-600">
                Proses yang sederhana namun powerful untuk mengelola semua
                kebutuhan dokumen Anda
              </p>
            </div>
        ...
        >
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-3xl text-xl text-gray-600">
                Evolusi sistem manajemen dokumen menuju masa depan yang lebih
                efisien
              </p>
            </div>
              ...
              {[
                {
                  year: '2024',
                  title: 'Era Digital',
                  desc: 'Transformasi penuh ke sistem digital modern',
                },
                {
                  year: '2023',
                  title: 'Cloud Integration',
                  desc: 'Integrasi cloud untuk akses global',
                },
                {
                  year: '2022',
                  title: 'AI Enhancement',
                  desc: 'Penambahan fitur AI untuk automasi',
                },
                {
                  year: '2021',
                  title: 'Security Focus',
                  desc: 'Implementasi keamanan tingkat enterprise',
                },
              ].map((item, index) => (
                <div
                  key={index}
              ...
              {[
                {
                  ...
                  rating: 5,
                  quote:
                    'BerkasApp telah mengubah cara kami mengelola dokumen. Proses yang dulu memakan waktu berjam-jam, kini hanya butuh beberapa menit.',
                },
                {
                  name: 'Ahmad Rizki',
                  ...
                  rating: 5,
                  quote:
                    'Keamanan data yang luar biasa dan interface yang sangat user-friendly. Tim kami sangat puas dengan performa sistem ini.',
                },
                {
                  name: 'Maya Sari',
                  ...
                  rating: 5,
                  quote:
                    'Fitur kolaborasi real-time memungkinkan tim kami bekerja lebih efisien, bahkan saat remote working.',
                },
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            >
              ...
              dokumen mereka kepada BerkasApp
            </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p
                ...
                style={{ animationDelay: '0.3s' }}
              >
                Solusi manajemen dokumen modern untuk era digital yang
                mengutamakan keamanan, kecepatan, dan kemudahan penggunaan.
              </p>
